...
...
["春休み",[">-0.4春季休",">-0.4春期休","春休み"]],
["サプライチェーン・マネジメント",["サプライチェーン・マネジメント",">-0.2SCM"]]
]
    OUTPUT
  end
...
...
["春休み","(>-0.4春季休) OR (>-0.4春期休) OR (春休み)"],
["サプライチェーン・マネジメント","(サプライチェーン・マネジメント) OR (>-0.2SCM)"]
]
      OUTPUT
    end
  end
...
...
  ('春期休', ARRAY['>-0.4春季休', '春期休', '>-0.4春休み']),
  ('春休み', ARRAY['>-0.4春季休', '>-0.4春期休', '春休み']),
  ('サプライチェーン・マネジメント', ARRAY['サプライチェーン・マネジメント', '>-0.2SCM']);
      OUTPUT
    end
